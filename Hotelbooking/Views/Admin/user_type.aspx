<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/admin_pannel.Master" AutoEventWireup="true" CodeBehind="user_type.aspx.cs" Inherits="Hotelbooking.Views.Admin.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="mb-3">
                <asp:DropDownList ID="stat" runat="server">
                    <asp:ListItem Value="0" Selected="True" Text="Select a status">Select a status</asp:ListItem>
        ...
        <div class="col-md-9">
            <asp:GridView ID="userview" runat="server" AutoGenerateSelectButton="True" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" OnSelectedIndexChanged="userview_SelectedIndexChanged">
                <Columns>
