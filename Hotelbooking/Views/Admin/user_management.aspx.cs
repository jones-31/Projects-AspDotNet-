...
namespace Hotelbooking.Views.Admin
{
    public partial class WebForm5 : System.Web.UI.Page
    {
        ...
        protected void editbtn_Click(object sender, EventArgs e)
        {
            ...
            if (fname.Text == "" || lname.Text == "" || user_emailid.Text == "" || phoneno.Text == "" || user_password.Text == "" || addr.Text == "" || stat.SelectedValue == "0" || type.SelectedValue == "0")
            {
            ...
            else
            {
                using (SqlConnection con1 = new SqlConnection(cs))
                {
                    ...
                    cmd1.Parameters.AddWithValue("@type", type.SelectedItem.Text);
        ...
        protected void usermanag_SelectedIndexChanged(object sender, EventArgs e)
        {
            user_emailid.Text = usermanag.SelectedRow.Cells[1].Text;
            user_password.Text = usermanag.SelectedRow.Cells[2].Text;
            phoneno.Text = usermanag.SelectedRow.Cells[3].Text;
            fname.Text = usermanag.SelectedRow.Cells[4].Text;
            addr.Text = usermanag.SelectedRow.Cells[6].Text;
            lname.Text = usermanag.SelectedRow.Cells[5].Text;
            stat.SelectedValue = usermanag.SelectedRow.Cells[8].Text;
            type.SelectedValue = usermanag.SelectedRow.Cells[7].Text;
