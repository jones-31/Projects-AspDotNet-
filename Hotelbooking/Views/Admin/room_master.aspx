...
<%--    <h1>room master</h1>--%>
    <div class="row" style="height: 100%;">
        <div class="col-md-3">
            ...
            <div class="mb-3">
                <asp:DropDownList ID="roomtyp" runat="server" DataValueField="roomtype" DataTextField="roomtype">
                </asp:DropDownList>
   ...
   --%>         </div>
             ...
             <div class="mb-3">
                ...
                <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ControlToValidate="cancelprice" runat="server" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>--%>
        ...
        <div class="col-md-9">
            ...
            <div style="overflow-x:auto;width:1150px;overflow-y:auto;height:600px">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="roomimg" HeaderText="Room Img Path" NullDisplayText="NA" ItemStyle-Width="10%" >
                    
                    <ItemStyle BorderStyle="Dotted" HorizontalAlign="Left" VerticalAlign="Middle" />
                    </asp:BoundField>
