...
namespace Hotelbooking.Views.Admin
{
    public partial class WebForm5 : System.Web.UI.Page
    {
        ...
        protected void usermanag_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            addr.Text = usermanag.SelectedRow.Cells[5].Text;
            lname.Text = usermanag.SelectedRow.Cells[6].Text;
            stat.SelectedItem.Text = usermanag.SelectedRow.Cells[7].Text;
            type.SelectedItem.Text = usermanag.SelectedRow.Cells[8].Text;
        }
