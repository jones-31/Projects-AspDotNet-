<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/admin_pannel.Master" AutoEventWireup="true" CodeBehind="user_management.aspx.cs" Inherits="Hotelbooking.Views.Admin.WebForm5" %>
    ...
    <div class="row ">
        <div class="col-md-3">
            ...
            <div class="mb-3">
                ...
                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="fname" runat="server" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>--%>
            </div>
            <%--Second name --%>
            <div class="mb-3">
                ...
                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="lname" runat="server" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>--%>
            ...
            <div class=" mb-3">
                ...
                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="phoneno" runat="server" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>--%>
            ...
            <div class="mb-3">
                ...
                <div id="addr_val"></div>
                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator4" ControlToValidate="addr" runat="server" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>--%>
            ...
            <div class="mb-3">
                ...
                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="user_emailid" runat="server" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>--%>
            ...
            <div class="mb-3">
                ...
                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator6" ControlToValidate="user_password" runat="server" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>--%>

            </div>

            <div class="mb-3">
                <asp:DropDownList ID="stat" runat="server">
                    <asp:ListItem Value="0" Selected="True">Select a status</asp:ListItem>
                    <asp:ListItem Text="Active">Active</asp:ListItem>
                    <asp:ListItem Text="Inactive">Inactive</asp:ListItem>
                   
                </asp:DropDownList>
                  <div id="stat_val"></div>
                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator7" ControlToValidate="stat" runat="server" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>--%>
             ...
             <div class="mb-3">
                <asp:DropDownList ID="type" runat="server">
                    ...
                    <asp:ListItem Text="User">User</asp:ListItem>
                    
                </asp:DropDownList>
                   <div id="type_val"></div>
                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator8" ControlToValidate="type" runat="server" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>--%>
        ...
        <div class="col-md-9">
            <asp:GridView ID="usermanag" runat="server" AutoGenerateSelectButton="True" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" OnSelectedIndexChanged="usermanag_SelectedIndexChanged" >
                <Columns>
